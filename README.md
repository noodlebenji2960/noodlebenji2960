...
I'm a full-stack web developer working mainly with the MERN stack, based in La Rioja, Spain. I completed [The Odin Project](https://www.theodinproject.com/)'s full-stack JavaScript curriculum end to end, and I come from a design background — so I build interfaces that not only work, but look like someone cared.

<a href="https://www.benjaminchick.com/#/projects?lng=en">Check out some of my work.</a> | <a href="#-get-in-touch">Get in contact.</a>
...
- Freelance web work for local businesses in La Rioja.
- Developing new design systems and experimenting with emerging tech.
- Formalising my qualifications with a Técnico Superior (DAW/DAM) in Spain.
...
- **The Odin Project** — Full-stack JavaScript curriculum (completed)
- **BTEC Level 3 National Diploma in Art and Design (Interactive Media)** — West Suffolk College, UK · Merit-Merit-Merit
- **Studied Graphic Communication** — Norwich University of the Arts, UK
...
<a href="https://www.benjaminchick.com">
...
📚 Looking for my collected learning resources, favourite dev channels and recommended reading? See [RESOURCES.md](./RESOURCES.md).
